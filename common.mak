...
CCOMMONFLAGS = -nologo -DBLAK_PLATFORM_WINDOWS -DWIN64 -utf-8 \
	     -TP -GR- -EHsc- -MP -arch:AVX2 -std:c++17

CNORMALFLAGS = $(CCOMMONFLAGS) /Ot
CDEBUGFLAGS = $(CCOMMONFLAGS) -Zi -DBLAKDEBUG
CNODEBUGFLAGS = $(CCOMMONFLAGS) -DBLAKDEBUG
LINKNORMALFLAGS = /release
LINKDEBUGFLAGS = /debug
LINKNODEBUGFLAGS =
LINKCONSOLEFLAGS = -subsystem:console,6.00
LINKWINDOWSFLAGS = -subsystem:windows,6.00
...
INCLUDE = $(INCLUDE);$(BLAKINCLUDEDIR);$(LIBARCHIVEDIR);$(LIBPNGDIR);$(ZLIBDIR);$(TOPDIR)\include
